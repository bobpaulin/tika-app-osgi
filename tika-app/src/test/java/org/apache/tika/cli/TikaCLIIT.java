...
import org.apache.tika.main.Main;
...
public class TikaCLIIT {
    ...
    public void tearDown() throws Exception {
        ...
        //System.out.println("Output: " + outContent.toString(UTF_8.name()));
        //System.out.println("Error: " + errContent.toString(UTF_8.name()));
    }
    ...
    public void testDefaultConfigException() throws Exception {
        ...
        assertTrue(errContent.toString(UTF_8.name()).contains("TikaException"));
    }

    @Test
    public void testConfig() throws Exception {
        String[] params = new String[]{"--config="+testInputDir.toAbsolutePath().toString()+"/tika-config1.xml", resourcePrefix+"bad_xml.xml"};
        runFramework(params);
        String content = outContent.toString(UTF_8.name());
    ...
    public void runFramework(String[] params, String[] systemProps) throws Exception {
        ...
        IOUtils.copy(process.getErrorStream(), errContent);
        process.waitFor();
    }
    ...
    public void testConfigSerializationCustomMinimal() throws Exception {
        String[] params = new String[]{
                "--config=" + testInputDir.toAbsolutePath().toString() + "/tika-config2.xml",
                "--dump-minimal-config"};
        runFramework(params);
    ...
    public void testConfigSerializationCustomStatic() throws Exception {
        String[] params = new String[]{
                "--config=" + testInputDir.toAbsolutePath().toString() + "/tika-config2.xml", "--dump-static-config"};
        runFramework(params);
        String content = outContent.toString(UTF_8.name());
