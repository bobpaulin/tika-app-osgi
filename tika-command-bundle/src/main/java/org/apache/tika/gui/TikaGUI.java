...
public class TikaGUI extends JFrame
     ...
     */
    public static void startGUI(final TikaServiceFactory tikaServiceFactory) throws Exception{
        final TikaService tikaService = tikaServiceFactory.createTikaService();
        UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                new TikaGUI(new DigestingParser(
                        tikaService.getWrappedParser(),
